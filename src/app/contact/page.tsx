              ...
              >
                <div className="grid sm:grid-cols-2 gap-4">
                  <div>
                    ...
                    <input required className="mt-1 w-full rounded-xl border border-black/10 dark:border-white/10 bg-white dark:bg-gray-900 px-4 py-3 text-sm outline-none focus:ring-2 focus:ring-purple-500" />
                  </div>
                  <div>
                ...
                <div>
                  ...
                  <input type="email" required className="mt-1 w-full rounded-xl border border-black/10 dark:border-white/10 bg-white dark:bg-gray-900 px-4 py-3 text-sm outline-none focus:ring-2 focus:ring-purple-500" />
                </div>
                <div>
                ...
                <div>
                  ...
                  <textarea required rows={6} className="mt-1 w-full rounded-xl border border-black/10 dark:border-white/10 bg-white dark:bg-gray-900 px-4 py-3 text-sm outline-none focus:ring-2 focus:ring-purple-500" />
                </div>
                <button type="submit" className="inline-flex items-center gap-2 rounded-full px-6 py-3 text-sm font-bold text-white shadow-xl transition-all bg-gradient-to-r from-purple-500 to-pink-500 hover:scale-105">
                  Send Message
